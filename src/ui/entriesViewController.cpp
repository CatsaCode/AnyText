...
DEFINE_TYPE(AnyText::UI, EntriesViewController);

namespace AnyText::UI {

    void EntriesViewController::DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) {
