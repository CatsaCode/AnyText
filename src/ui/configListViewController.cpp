...
DEFINE_TYPE(AnyText::UI, ConfigListViewController);

namespace AnyText::UI {

    void ConfigListViewController::DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) {
